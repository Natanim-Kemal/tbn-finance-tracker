...
budgetSchema.statics.getRemainingBudget = async function (userID, budgetID) {
    try {
        ...
        // Check if the user has permission to access this budget (you can implement this logic based on your application requirements)
...
// You may need to add more methods or modify the existing ones based on your application logic.
